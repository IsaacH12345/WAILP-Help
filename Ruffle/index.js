...
(async () => {
    const response = await fetch("import "./index.css";
...
(async () => {
    const response = await fetch("https://cdn.jsdelivr.net/gh/IsaacH12345/WAILP-Help/Ruffle/swfs.json");
...
https://cdn.jsdelivr.net/gh/IsaacH12345/WAILP-Help/Ruffle/swfs.json");
